<html>
    <head>
        ...
        <script type="text/javascript" src="{{URL::('js/js_categories.js')}}"></script>
        <script type="text/javascript" src="{{URL::('js/js_days.js')}}"></script>
        <script type="text/javascript" src="{{URL::('js/jquery.stopwatch.js')}}"></script>
