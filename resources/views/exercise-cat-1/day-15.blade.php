@extends('master')
    @section('extra-head')
    <script type="text/javascript" src='/js/js_exercise-9.js'></script>
            ...
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="penutup">
                        ...
                        <form action="{{ route('inputHistoryDay15') }}" >
