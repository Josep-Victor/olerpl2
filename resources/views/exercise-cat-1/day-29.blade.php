@extends('master')
    @section('extra-head')
    <script type="text/javascript" src='/js/js_exercise-14.js'4></script>
    @endsection
    @section('konten')
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active"> Mountain Climber X 20</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Lunges X 20</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">                                    
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Russian Twist X 20</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">                                   
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Plank X 20</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">                                    
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Side Plank X 20</p>
                                        </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Hip Raises X 20</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">                                    
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">heel touch x 20</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">                                    
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Push-Ups With Rotation x 20</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
