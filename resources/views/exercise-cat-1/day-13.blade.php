@extends('master')
    @section('extra-head')
    <script type="text/javascript" src="{{asset('js/js_exercise-9.js')}}"></script>
    @endsection
    @section('konten')
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="card-text text-center">
                                                <p class="total-exercise">Push Up x 17</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Mountain Climber x 17</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">                                   
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">plank x 17</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
