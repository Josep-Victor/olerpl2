                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="card-text text-center">
                                                ...
                                                <p class="total-exercise-active">Push Up x 26</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Sit Up x 26</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Squat x 26</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Star Jump x 26</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Mountain Climber x 26</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Lunges x 26</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">                                    
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Russian Twist x 26</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">                                    
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            ...
                                            <p class="total-exercise-active">Hip Raises x 26</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
