@extends('master')
    @section('extra-head')
    <script type="text/javascript" src="{{asset('js/js_exercise-8.js')}}"></script>
    @endsection
    @section('konten')
                            ...
                            <div class="exercise-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="total-exercise-active">Mountain Climber x 14 </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md">
                            <div class="exercise-8">
                                <div class="card">                                    
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                        <p class="total-exercise"> lunges x ??</p>
                        ...
                        <div class="col-md">
                            <div class="exercise-8">
                                <div class="card">                                    
                                    ...
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                        <p class="total-exercise"> russian twist x ??</p>
