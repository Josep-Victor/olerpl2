    ...
    @section('konten')
        <section id="ole" class="day-one pb-5">
            <div class="container">          
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col">
                            <div class="exercise-5 final-day-1">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay2">
                                    <div class="card">
                ...
                <div class="modal fade" id="selesaiDay2" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <p>Selamat!</p>
                        <p>Kamu telah menyelesaikan olahraga hari 2 dengan waktu 
