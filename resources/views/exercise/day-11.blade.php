@extends('master')
    ...
    <?php 
        ...
        $squat = $squat+5;
        $starjump = $starjump+5;
        $mountainclimber = $mountainclimber+5;
        $cobras = $cobras+10;
        $lunges = $lunges+5;
        $russiantwist = $russiantwist+5;
    ?>
        <section id="ole" class="day-one pb-5">
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col">
                            <div class="exercise-8 final-day-11">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay11">
                                <div class="card">                                    
                    ...
                    <div class="modal fade" id="selesaiDay11" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 11 dengan waktu 
