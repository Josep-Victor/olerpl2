        ...
        <section id="ole" class="day-one pb-5">
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col">
                            <div class="exercise-8 final-day-10">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay10">
                                <div class="card">                                    
                    ...
                    <div class="modal fade" id="selesaiDay10" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <center>
                            <form action="{{ route('inputHistoryDay10') }}" >
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 10 dengan waktu 
