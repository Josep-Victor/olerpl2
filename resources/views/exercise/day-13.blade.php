@extends('master')
    ...
    <?php 
        ...
        $squat = $squat+6;
        $starjump = $starjump+6;
        $mountainclimber = $mountainclimber+6;
        $cobras = $cobras+10;
        $lunges = $lunges+6;
        $russiantwist = $russiantwist+6;
    ?>
            ...
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col">
                            <div class="exercise-9 final-day-13">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay13">
                                <div class="card">                                   
                    ...
                    <div class="modal fade" id="selesaiDay13" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <center>
                            <form action="{{ route('inputHistoryDay13') }}" >
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 13 dengan waktu 
