@extends('master')
    ...
    <?php 
        ...
        $squat = $squat+8;
        $starjump = $starjump+8;
        $mountainclimber = $mountainclimber+8;
        $cobras = $cobras+15;
        $lunges = $lunges+8;
        $russiantwist = $russiantwist+8;
    ?>
    <section id="ole" class="day-one pb-5">
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col">
                            <div class="exercise-10 final-day-17">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay17">
                                <div class="card">                                   
                    ...
                    <div class="modal fade" id="selesaiDay17" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 17 dengan waktu 
