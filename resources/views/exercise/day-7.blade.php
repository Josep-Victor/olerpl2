            ...
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col">
                            <div class="exercise-7 final-day-7">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay7">
                                <div class="card">
                    ...
                    <div class="modal fade" id="selesaiDay7" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <center>
                            <form action="{{ route('inputHistoryDay7') }}" >
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 7 dengan waktu 
