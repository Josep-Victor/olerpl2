@extends('master')
    ...
    <?php 
        ...
        $situp = $situp+14;
        $squat = $squat+14;
        $starjump = $starjump+14;
        $mountainclimber = $mountainclimber+14;
        $cobras = $cobras+20;
        $lunges = $lunges+14;
        $russiantwist = $russiantwist+14;
        $hipraises = $hipraises+14;
        $plank = $plank+10;
        $sideplank = $sideplank+10;
        $heeltouch = $heeltouch+14;
        $pushupwr = $pushupwr+14;
    ?>
            ...
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="col">
                        ...
                        <div class="col">
                            <div class="exercise-14 final-day-30">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay30">
                                <div class="card">                                    
                    ...
                    <div class="modal fade" id="selesaiDay30" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <center>
                            <form action="{{ route('inputHistoryDay30') }}" >
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 30 dengan waktu 
