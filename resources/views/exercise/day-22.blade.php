@extends('master')
    ...
    <?php 
        ...
        $situp = $situp+10;
        $squat = $squat+10;
        $starjump = $starjump+10;
        $mountainclimber = $mountainclimber+10;
        $cobras = $cobras+20;
        $lunges = $lunges+10;
        $russiantwist = $russiantwist+10;
        $hipraises = $hipraises+10;
        $plank = $plank+10;
        ...
        <section id="ole" class="day-one pb-5">
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col">
                            <div class="exercise-12 final-day-22">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay22">
                                <div class="card">
                                    <img class="card-img-top" src="{{asset('img/cobra stretch.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <div class="card-text text-center">
                                            <p class="total-exercise">Cobra Stretch ??s</p>
                                            <p class="total-exercise-active">Cobra S. {{ $cobrastretch }}s</p>
                                        </div>
                                    </div>
                                </div>
                                </a>
                    ...
                    <div class="modal fade" id="selesaiDay22" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 22 dengan waktu 
