@extends('master')
    ...
    <?php 
        ...
        $situp = $situp+11;
        $squat = $squat+11;
        $starjump = $starjump+11;
        $mountainclimber = $mountainclimber+11;
        $cobras = $cobras+20;
        $lunges = $lunges+11;
        $russiantwist = $russiantwist+11;
        $hipraises = $hipraises+11;
        $plank = $plank+10;
        ...
        <section id="ole" class="day-one pb-5">
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col">
                            <div class="exercise-12 final-day-23">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay23">
                                <div class="card">
                                    <img class="card-img-top" src="{{asset('img/cobra stretch.jpg')}}" alt="Card image cap">
                                    <div class="card-body">
                                        <div class="card-text text-center">
                    ...
                    <div class="modal fade" id="selesaiDay23" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 23 dengan waktu 
