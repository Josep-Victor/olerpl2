        ...
        <section id="ole" class="day-one pb-5">
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="row pt-5">
                        <div class="col">
                            <div class="exercise-6 final-day-5">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay5">
                                <div class="card">
                    ...
                    <div class="modal fade" id="selesaiDay5" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <center>
                            <form action="{{ route('inputHistoryDay5') }}" >
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 5 dengan waktu 
