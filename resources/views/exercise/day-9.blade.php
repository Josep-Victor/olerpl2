@extends('master')
    ...
    <?php 
        ...
        $squat = $squat+4;
        $starjump = $starjump+4;
        $mountainclimber = $mountainclimber+4;
        $cobras = $cobras+5;
        $lunges = $lunges+4;
    ?>
            ...
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col">
                            <div class="exercise-7 final-day-9">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay9">
                                <div class="card">
                    ...
                    <div class="modal fade" id="selesaiDay9" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <center>
                            <form action="{{ route('inputHistoryDay9') }}" >
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 9 dengan waktu 
