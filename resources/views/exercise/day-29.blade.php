            ...
            <div class="container">          
                <div class="judul">
                    ...
                    <div class="col">
                        ...
                        <div class="col">
                            <div class="exercise-14 final-day-29">
                                <a href="#" data-toggle="modal" data-target="#selesaiDay29">
                                <div class="card">                                    
                    ...
                    <div class="modal fade" id="selesaiDay29" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <center>
                            <form action="{{ route('inputHistoryDay29') }}" >
                            <p>Selamat!</p>
                            <p>Kamu telah menyelesaikan olahraga hari 29 dengan waktu 
