$(document).ready(function(){
    ...
    $(".exercise-13").click(function(){
        if (exerciseClicked12 == true && exerciseClicked14 != true) {
        ...
        $('.exercise-14 .total-exercise').replaceWith($('.exercise-14 .total-exercise-active').text());
        
        $('.img-preview').fadeOut(500, function() {
            $('.img-preview').attr("src",$('.img-preview-14').attr("src"));
        $('.img-preview').fadeIn(500);
        });
    }
        else if (exerciseClicked12 != true) {
            alert("selesaikan dulu latihan sebelumnya !");
        }
    ...
    var exerciseClicked14;
    $(".exercise-14").click(function(){
        if (exerciseClicked13 == true) {
            exerciseClicked14 = true;
            $(this).animate({
                opacity: 0.5
            });
    ...
    $(".final-day-28").click(function(){
        localStorage.setItem("Hari28-cat1", 1);
    });
    
    $(".final-day-29").click(function(){
        localStorage.setItem("Hari29-cat1", 1);
    });

    $(".final-day-30").click(function(){
        localStorage.setItem("Hari30-cat1", 1);
    });
